...
import resource_classes.IntQuestion;
import resource_classes.SubtractionQuestion;
import resource_classes.TextIO;

public class AddAndSubtractQuiz {

    public void giveQuiz(){
        IntQuestion[] quizQs = makeQuiz();
        int[] responses = administerQuiz(quizQs);
        gradeQuiz(quizQs, responses);
    }

    IntQuestion[] makeQuiz(){
        IntQuestion[] quiz = new IntQuestion[10];
    ...
    int[] administerQuiz(IntQuestion[] quiz){
    ...
    void gradeQuiz(IntQuestion[] quiz, int[] responses){
